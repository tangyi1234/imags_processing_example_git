...
- (void)sd_internalSetImageWithURL:(nullable NSURL *)url
    ...
    //看operationKey中是否有存在，有就添加到SDOperationsDictionary集合中。
    ...
    if (url) {
#if SD_UIKIT
        // check if activityView is enabled or not 检查是否启用了activityView
        ...
        //创建整个管理者(这里还创建了SDImageCache和SDWebImageDownloader)
        /**
         SDImageCache: 用于缓存
